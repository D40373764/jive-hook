 ...
 * @generated
 */
public class RestLocalServiceClp implements RestLocalService {
    ...
    public RestLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public com.liferay.portal.kernel.json.JSONObject post(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName5,
                    ...
                    ClpSerializer.translateInput(post)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.liferay.portal.kernel.json.JSONObject updateStatus(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName7,
                    ...
                    new Object[] { ClpSerializer.translateInput(body) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
